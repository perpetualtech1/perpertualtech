                        ...
                        <div className="flex flex-wrap items-center -mx-3">
                            ...
                            <div className="w-full lg:w-1/2 px-3 lg:bg-blueGray-10 mb-12 lg:mb-0 pb-10">
                                <div className="flex items-center justify-center">
                                    <img className="lg:max-w-lg" src="/assets/imgs/illustrations/about.svg" alt="Monst" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-wrap -mx-3 -mb-6 text-center">
                            <div className="hover-up-5 w-full md:w-1/2 lg:w-1/3 px-3 mb-6 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                                <div className="p-12 bg-white shadow rounded">
                                    ...
                                    <img className="h-36 mx-auto my-4" src="/assets/imgs/illustrations/about.svg" alt="Monst" />
