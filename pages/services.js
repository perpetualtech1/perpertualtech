            ...
            <Layout>
                                    ...
                                    <div className="flex flex-wrap">
                                        <div className="w-full md:w-1/2 items-start pt-4 pb-8 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-blueGray-400 leading-loose text-sm">Effective web design guides users’ eyes and tells them where to look..</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="w-full md:w-1/2 items-start py-4 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-blueGray-400 leading-loose text-sm">Marketing through social media is a great way to gain new insights, acquire loyal customers, and get creative.</p>
                                            </div>
                                        </div>
                ...
                {/* <section className="pt-12">
                    <div className="container py-12 mx-auto">
                        <div className="flex  flex-wrap">
                            <div className="w-full md:w-1/2 pr-12 px-3 order-0 md:order-0 mb-12 md:mb-0 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                <img className="sm:max-w-sm lg:max-w-full mx-auto" src="/assets/imgs/placeholders/img-5.jpg" alt="Monst" />
                            </div>
                            <div className="w-full md:w-1/2 px-3 order-1 md:order-1">
                                <div className="max-w-md-2">
                                    <div className="mb-4">
